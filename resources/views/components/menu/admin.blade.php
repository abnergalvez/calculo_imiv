<li class="nav-item">
        ...
        <div class="multi-level collapse {{ Request::segment(2) == 'mantenedores' ? 'show' : '' }}" role="list"
          ...
          <ul class="flex-column nav">
            ...
            <li class="nav-item {{ Request::segment(3) == 'tipos_proyectos' ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('admin.type_projects.index') }}" >
      ...
      <li class="nav-item {{ Request::segment(2) == 'perfil' ? 'active' : '' }}">
