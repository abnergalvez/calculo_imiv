...
@section('content_auth')
    ...
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            <p class="text-center"><a href="{{ route('home') }}" class="text-gray-700"><i
                class="fas fa-angle-left me-2"></i>Volver a Calculos GYS</a></p> 
            <div class="row justify-content-center form-bg-image"
                data-background-lg="/assets/img/illustrations/signin.svg">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-3 h3">Ingreso Gestión GYS</h1>
                        </div>
                        <form method="POST" action="{{ route('login') }}" class="mt-4" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="{{ route('password.request') }}" class="small text-right">Olvido su contraseña ?</a></div>
                                </div>
                            </div>
                            <div class="d-grid">
