                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                ...
                                <input name="budget_entry_days_limit" class="form-control" id="budget_entry_days_limit" value="{{ $type_project->budget_entry_days_limit }}" type="number" min="1" step="1" >
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="observation_days_limit">Límite días para<br>  Obsevacion </label>
                                <input name="observation_days_limit" class="form-control" id="observation_days_limit" value="{{ $type_project->observation_days_limit }}" type="number" min="1" step="1" >
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="re_entry_days_limit">Límite días para<br>  Segundo Ingreso </label>
                                <input name="re_entry_days_limit" class="form-control" id="re_entry_days_limit"  value="{{ $type_project->re_entry_days_limit }}" type="number" min="1" step="1" >
                            </div>
                        </div>
						<div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="final_status_days_limit">Límite días para<br>  Aprobación / Rechazo </label>
                                <input name="final_status_days_limit" class="form-control" id="final_status_days_limit" value="{{ $type_project->final_status_days_limit }}" type="number" min="1" step="1" >
                            </div>
                        </div>
                    </div>
                    <div class="mt-0">
