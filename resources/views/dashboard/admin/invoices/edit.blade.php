...
<div class="row">
    <form action="{{ route('admin.projects.invoices.update',[$project , $invoice]) }}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div>
                                ...
                                <input name="number" class="form-control" id="number" type="text" placeholder="Ingrese Numero Factura" value="{{ $invoice->number }}" required>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div>
                                <label for="amount">Monto ($) *</label>
                                <input name="amount" class="form-control " id="amount" type="text" placeholder="Ingrese Monto $" value="{{ $invoice->amount }}" required>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
								...
								<input data-datepicker="" name="accepted_date" class="form-control" id="accepted_date" type="text" placeholder="dd-mm-yyyy" value="{{ $invoice->accepted_date ? Carbon\Carbon::createFromFormat('Y-m-d', $invoice->accepted_date)->format('d-m-Y') : ''}}">
							</div>
                        </div>
