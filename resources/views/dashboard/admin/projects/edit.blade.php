                    ...
                    <div class="row">
						<div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
								...
								<input data-datepicker="" name="entry_date" class="form-control" id="entry_date" type="text" placeholder="dd-mm-yyyy"  value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $project->entry_date)->format('d-m-Y') }}" required>
							</div>
                        </div>
						<div class="col-md-4 mb-3">
