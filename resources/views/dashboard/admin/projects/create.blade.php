					...
					<div class="row">
						<div class="col-md-4 mb-3">
                            ...
                            <select name="status" class="form-select mb-0 select2" id="status" aria-label="seleccione el estado" placeholder="Seleccione...">
                                <option value="" >Seleccione...</option>
                                <option value="adjudication">Adjudicado</option>
                                <option value="to_engineer">Entregado a Ingeniero</option>
								<option value="registered_for_observation" selected>Primer Ingreso</option>
								<option value="in_correction">Observaciones</option>
								<option value="re_entered">Segundo Ingreso</option>
								<option value="accepted">Aprobación</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
								...
								<input data-datepicker="" name="adjudication_date" class="form-control" id="adjudication_date" type="text" placeholder="dd-mm-yyyy" >
							</div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
								...
								<input data-datepicker="" name="to_engineer_date" class="form-control" id="to_engineer_date" type="text" placeholder="dd-mm-yyyy" >
							</div>
                        </div>
